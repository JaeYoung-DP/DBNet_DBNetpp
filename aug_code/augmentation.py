...
image_folder_path = "./data/ship_data/fixed_i"
label_folder_path = "./data/ship_data/fixed_g"
output_image_folder_path = "./data/ship_data/aug_i"
output_label_folder_path = "./data/ship_data/aug_g"
